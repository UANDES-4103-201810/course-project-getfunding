...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post wishlists_url, params: { wishlist: { Project_id: @wishlist.Project_id, User_id: @wishlist.User_id } }
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { Project_id: @wishlist.Project_id, User_id: @wishlist.User_id } }
